...
export default function LandingPage(){
    ...
    return(
        <div className='min-w-screen relative overflow-x-clip h-screen bg-zBlueGreen-500 flex flex-col justify-center items-center'>
          ...
          <div className='md:px-8 px-2 py-2 md:py-4 border-white border-4 rounded-2xl w-fit  hover:scale-110 transition-all duration-300 z-50'>
            <Image 
              src={logo}
              alt="Company logo"
              className='ml-4 w-[300px] md:w-[600px] block left-0'
            />
          </div>
          <div className='z-50 h-fit flex flex-row oldmacbookfix:flex-col items-center absolute bottom-0 pb-8 oldmacbookfix:pb-6'>
            <div className={`bg-zGreen-500 px-8 py-2 border-2 z-50 h-fit shadow-harsh5px hover:shadow-harsh10px font-poppins border-softBlack-500 flex flex-col items-center font-bold hover:bg-zPink-500 transition-all duration-300 text-xl active:scale-90 active:shadow-harsh5px hover:rounded-2xl`} onClick={doLogin}>Login</div>
            <a href='/termsandconditions' target='_blank' className='flex flex-col items-center'>
